  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      <div className='absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center'>
        <a href='#about'>
          <div className='w-[30px] h-[54px] rounded-3xl border-4 border-secondary flex justify-center items-center p-2'>
            <motion.div
              animate={{
                y: [0, 24, 0],
              }}
              ...
              className='w-2.5 h-2 rounded-full bg-secondary mb-7'
            />
          </div>
        </a>
      </div>
